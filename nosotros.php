...
<body>
    <div class="container-fluid bg-main">
        ...
        <div class="row d-flex justify-content-center py-3 bg-phrase">
            <h1 class="text-white text-center">
                    Escuela de Posgrado de la USMP
            </h1>
    ...
    <div class="container bk-contenido">
        <div class="row pt-5 justify-content-md-center ">
            ...
            <div class="col-12 col-md-6 text-center" >
                <picture>
                    <img src="images/pic-nosotros-01.jpg" alt="" class="img-fluid"> <br>
                    <span class="text-center">El Ing. José Antonio Chang Escobedo, Rector de la USMP, y el Dr. Moisés Tambini del Valle, Director de la Escuela de Posgrado de la USMP</span>
                </picture>
            ...
            <div class="col-12  col-md-6  mt-4 text-center ">
                <picture>
                    <img src="images/all-team-01.jpg" alt="" class="img-fluid"> <br>
                    <span class="text-center">El Ing. José Antonio Chang Escobedo, Rector de la USMP, y el Dr. Moisés Tambini del Valle, Director de la Escuela de Posgrado de la USMP</span>
                </picture>
            </div>
